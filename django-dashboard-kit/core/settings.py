...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_NAME', 'sgwtime'),  # Nome do banco
        'USER': os.getenv('POSTGRES_USER', 'wtime'),  # Usuário
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'wtimepassword'),  # Senha
        'HOST': os.getenv('POSTGRES_HOST', 'postgres_db'),  # Nome do serviço do container
        'PORT': os.getenv('POSTGRES_PORT', '5432'),  # Porta
    }
}
